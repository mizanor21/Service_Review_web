            ...
            <div className="navbar container mx-auto">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            <li><Link to={'/blog'}>Blog</Link></li>
                            {
                                currentUser?.uid ?
                                    <>
                                        <li><Link to={''}><li className=''>My Reviews</li></Link></li>
                                        <li><Link to={'/add-service'}><li>Add Services</li></Link></li>
                                    </>
                                    :
                                    <></>
                            }
                    ...
                    <Link to={'/'} className="flex items-center justify-center ">
                        <Link to={'/'} className="btn btn-ghost normal-case text-3xl p-0 m-0">
                            {/* <img className='w-24 ' src={logo} alt="logo not found" /> */}
                            Hungry<span className='text-amber-400'>Naki</span></Link>
